            ...
            <main class="col-lg-10 col-md-6 py-4">
                <div class="content-card">
                    <div class="row">
                        ...
                        {{-- <h5 class="col-md-2"><button class="btn btn-primary" type="submit">Mark as completed</button>
                        </h5> --}}
                    </div>
                    <div class="container">
                    </div>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr>
                                    {{-- <th>
                                        <input type="checkbox" name="productId[]" value="{{ $order->id }}">
                                    </th> --}}
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('order.editOrder', $order) }}"
