                        ...
                        <div class="checkout-container">
                            ...
                            <div class="checkout-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $order->name }}" type="text" class="form-control" id="name"
                                        name="name" placeholder="Enter your full name" required>
                                </div>

                                <div class="form-group">
                                    <label for="phone">Phone Number</label>
                                    <input value="{{ $order->phone }}" type="tel" class="form-control" id="phone"
                                        name="phone" placeholder="0111234567">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="address">Delivery Address <span
                                            style="color: #dc3545;">*</span></label>
                                    <input value="{{ $order->address }}" type="text" class="form-control" id="address"
                                        name="address" placeholder="Street address, apartment, suite, etc." required>
                                </div>

                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="city">City <span style="color: #dc3545;">*</span></label>
                                        <input value="{{ $order->city }}" type="text" class="form-control" id="city"
                                            name="city" placeholder="City" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="postcode">Post Code <span style="color: #dc3545;">*</span></label>
                                        <input value="{{ $order->postcode }}" type="text" class="form-control" id="postcode"
                                            name="postcode" placeholder="12345" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="3"
                                        placeholder="Any special instructions for delivery..." >{{ $order->notes }}</textarea>
                                </div>

                                <button type="submit" class="btn-checkout">Update</button>
