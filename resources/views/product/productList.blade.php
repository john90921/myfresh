<x-app-layout>
    ...
    <div class="container-fluid layout-wrapper">
        ...
        <h5 class="mb-3 col-md-2">
                     ...
                     <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-footer">
                                    <div class="product-price">${{ $product->packages[0]->price }}</div>
                                    <a href="{{ route('product.show', $product->id) }}" class="btn-add-cart">View</a>
                    ...
                    <div class="container text-align-end"  style="width: auto">
